...
const startServer = async () => {
  try {
    ...
    app.use((req, res, next) => {
      ...
      if (
        contentLength &&
        Number(contentLength) > 300 * 1024 * 1024
      ) {
        return res.status(413).json({
          success: false,
          message:
            "File too large. Max 300MB allowed.",
        });
      }
    ...
    // =====================================================
    // PAYSTACK WEBHOOK DEBUG MIDDLEWARE
    // =====================================================
    //
    // This lets us confirm that Paystack's request
    // actually reaches this Express application.
    //
    // IMPORTANT:
    // This must be BEFORE the webhook route.
    // =====================================================
